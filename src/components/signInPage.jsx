...
const SignInPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://smart-home-backend-xyir.onrender.com/login`, {
        method: "POST",
        headers: {
  ...
  onSuccess={async (credentialResponse) => {
    try {
      ...
      const checkRes = await fetch("https://smart-home-backend-xyir.onrender.com/check-user", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (!checkData.exists) {
        const res = await fetch("https://smart-home-backend-xyir.onrender.com/signup-with-google", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
